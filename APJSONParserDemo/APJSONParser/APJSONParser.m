...
- (void)setNullParseType:(APJSONParserNullParseType)nullParseType
{
...
- (instancetype)init
{
    if (self = [super init]) {
        ...
        self.nullParseType = APJSONParserNullParseTypeDefautNull;
